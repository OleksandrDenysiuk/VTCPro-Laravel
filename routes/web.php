...
Route::get(
    ...
    function () {
        $data = PushNotification::app('IOSProvider')
            ->to('a29f03c7f73af0009a8a120f6e39078a22f0d0cc9e69be5a0b82e44aab8172c1')
...
Route::get(
    '/send/android/push',
    function () {
        Helper::sendFCM('d8LMimODsvw:APA91bEMH1VtgD9hrsDSjb1m-CL7pbFUAsPGrgk_D9uWc9viRoSqZF71eFSvMUw1RgjGX0KDhDW0AI4XcRaDQDVzMzUR1rQnwgJPpQuMeVWKGg-Naw4eLfbN-sv-cTv-C0vLqj7xV7Ml',
         'Hello World, i`m a push message');
...
Route::get('/asdf/asdf', function() {
    $request = UserRequests::where('id',236)->first();
    (new SendPushNotification)->AcceptedScheduledRide($request);
    (new SendPushNotification)->CancelledScheduledRide($request);
});
