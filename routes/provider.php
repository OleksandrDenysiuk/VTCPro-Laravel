...
Route::get('/requests/{id}', 'ProviderController@requestShow')->name('request.show');

Route::get('/earnings', 'ProviderController@earnings')->name('earnings');
Route::get('/earnings-pdf', 'ProviderController@earnings_pdf')->name('earnings.pdf');
...
Route::post('/dispute_store', 'ProviderController@dispute_store_web');
//waiting time
