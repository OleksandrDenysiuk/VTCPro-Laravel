...
Route::group(['middleware' => ['provider.api']], function () {
    ...
    Route::post('card/delete', 'Resource\ProviderCardResource@delete_card');
    ...
    Route::group(['prefix' => 'requests'], function () {
        ...
        Route::post('/upcoming/cancel' ,'ProviderResources\TripController@scheduled_cancel');
        Route::post('/upcoming/accept' ,'ProviderResources\TripController@scheduled_accept');
    ...
    Route::get('/get_advertisements', 'Resource\AdvertisementResource@get_provider_advertisement');
