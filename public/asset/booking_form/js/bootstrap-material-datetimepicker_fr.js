(function ($, moment)
{
   ...
   function Plugin(element, options)
   {
      ...
      this.params = {date: true, time: true, format: 'YYYY-MM-DD', minDate: null, maxDate: null, currentDate: null, lang: 'fr', weekStart: 0, disabledDays: [], shortTime: false, clearButton: false, nowButton: false, cancelText: 'Annuler', okText: 'OK', clearText: 'Effacer', nowText: 'Maintenant', switchOnClick: false, triggerEvent: 'focus', monthPicker: false, year:true};
