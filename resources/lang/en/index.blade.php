            ...
            <table class="table table-striped table-bordered dataTable" id="table-2">
                <thead>
                    <tr>
                        ...
                        <th>@lang('admin.dispatcher.affli')</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>+339876543210</td>
                        @else
                        <td>{{ $provider->country_code }}{{ $provider->country_code }}{{ $provider->mobile }}</td>
                        @endif
                        @if(Setting::get('demo_mode',0) == 1)
                        <td>admin</td>
                        @else
                        <td>{{ $dispatcher->guard_name }}</td>
                        @endif
                        <td>
                            <form action="{{ route('admin.dispatch-manager.destroy',$dispatcher->id) }}" method="POST">
                                ...
                                <button class="btn btn-danger" onclick="return confirm('@lang('admin.perso.sureare')')><i; class=" fa fa-trash"></i> @lang('admin.delete')</button>
                                @endif
                            </form>
                        </td>
                    </tr>
