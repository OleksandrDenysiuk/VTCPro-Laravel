...
@section('content')
    <div class="banner row no-margin" style="background-image: url('{{ asset('asset/img/banner-bg.jpg') }}');">
        ...
        <div class="container pad-60">
            <div class="col-md-8">
                <h2 class="banner-head"><span class="strong">Réservez votre trajet</span><br>quand vous voulez et où que vous alliez</h2>
            </div>
            <div class="col-md-4">
        ...
        <div class="container ">
            ...
            <div class="col-md-4 content-block small">
                <div class="box-shadow">
                    ...
                    <h2>Réservez votre chauffeur tout simplement</h2>
                    <div class="title-divider"></div>
                    <p>{{ config('constants.site_title', 'Tranxit')  }} est le moyen le plus intelligent de se déplacer. En un geste, une voiture vient directement à vous. Votre chauffeur sait exactement où aller. Et vous pouvez payer en espèces ou par carte.</p>
                </div>
            </div>
            ...
            <div class="col-md-4 content-block small">
                <div class="box-shadow">
                    ...
                    <div class="title-divider"></div>
                    <p>Enregistrez votre Carte de paiement pour être débité automatiquement. Vous pouvez également payez en espèces, directement auprès du chauffeur. Avec {{ config('constants.site_title', 'Tranxit') }}, vous avez le choix.</p>
                </div>
            </div>
            ...
            <div class="col-md-4 content-block small">
                <div class="box-shadow">
                    ...
                    <h2>Vous notez, nous écoutons</h2>
                    <div class="title-divider"></div>
                    <p>Évaluez votre conducteur et fournissez des commentaires anonymes sur votre voyage. Vos commentaires nous aident à faire de chaque sortie une expérience 5 étoiles.</p>
                </div>
            </div>
    ...
    <div class="row gray-section pad-60">
        <div class="container content-block">
            <div class="icon"><img src="{{ asset('asset/img/destination.png') }}"></div>
            <h2>Des tarifs adaptés<br>And any occasion</h2>
    ...
    <div class="row white-section pad-60">
        <div class="container">
            ...
            <div class="col-md-6 content-block">
                <div class="icon"><img src="{{ asset('asset/img/budget.png') }}"></div>
                <h4>TARIF</h4>
                <h2>Faire une Estimation</h2>
                <div class="title-divider"></div>
                <form method="post" id="idForm" onsubmit="return">

                    {{ csrf_field() }}
                    <div class="input-group fare-form">
                        <input type="text" class="form-control" placeholder="Lieu de départ" id="origin-input"
                               name="s_address">
                    </div>

                    <div class="input-group fare-form no-border-right">
                        <input type="text" class="form-control" placeholder="Lieu d'arrivé" id="destination-input"
                               name="d_address">
                    ...
                    <button type="submit" id="btnSubmit" class="full-primary-btn fare-btn">VOIR LE TARIF</button>
    ...
    <div class="row gray-section pad-60 full-section">
        <div class="container">
            ...
            <a class="content-more more-btn" href="{{url('login')}}">COMMENT NOUS VOUS GARANTISSONS VOTRE SÉCURITÉ <i class="fa fa-chevron-right"></i></a>
            </div>
        <!-- <div class="col-md-6 img-box text-center">
            <img src="{{ asset('asset/img/seat-belt.jpg') }}">
        </div> -->
            <div class="col-md-6 full-img text-center"
                 style="background-image: url({{ asset('asset/img/safty-bg.jpg') }});">
                ...
                <div class="col-md-8 col-md-offset-2">
                    <form>
                        <div class="input-group find-form">
                            <input type="text" class="form-control" placeholder="Recherchez" id="mode-selector"
                                   name="s_address1">
            ...
            $("#btnSubmit").click(function (event) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $("#div2").show();
                        $("#btnSubmit").hide();
                        $("#div1").html("Prix estimé - " + data.estimated_fare + "€");
                        $("#div2").html("Distance - " + data.distance + "km(s)");
