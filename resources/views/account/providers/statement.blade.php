    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            <div class="box box-block bg-white">
            	...
            	<div class="datemenu">
            		<span>
                        <a style="cursor:pointer" id="tday" class="showdate">@lang('admin.custom.todo')</a>
                        <a style="cursor:pointer" id="yday" class="showdate">@lang('admin.custom.yes')</a>
                        <a style="cursor:pointer" id="cweek" class="showdate">@lang('admin.custom.cure')</a>
                        <a style="cursor:pointer" id="pweek" class="showdate">@lang('admin.custom.pru')</a>
                        <a style="cursor:pointer" id="cmonth" class="showdate">@lang('admin.custom.cuss')</a>
                        <a style="cursor:pointer" id="pmonth" class="showdate">@lang('admin.custom.pdhh')</a>
                        <a style="cursor:pointer" id="cyear" class="showdate">@lang('admin.custom.chhd')</a>
                        <a style="cursor:pointer" id="pyear" class="showdate">@lang('admin.custom.kdoo')</a>
                    </span>
            	</div>
            	...
            	<div class="clearfix" style="margin-top: 15px;">
					<form class="form-horizontal" action="{{route('account.ride.statement.range')}}" method="GET" enctype="multipart/form-data" role="form">
						...
						<div class="form-group row col-md-5">
							...
							<div class="col-xs-8">
								<input class="form-control" type="date" name="from_date" id="from_date" required placeholder="@lang('admin.custom.dggd')">
							</div>
						</div>
						...
						<div class="form-group row col-md-5">
							...
							<div class="col-xs-8">
								<input class="form-control" type="date" required name="to_date" id="to_date" placeholder="@lang('admin.custom.ddssff')">
							</div>
						</div>
					...
					<div class="col-lg-4 col-md-6 col-xs-12">
						<div class="box box-block bg-white tile tile-1 mb-2">
							...
							<div class="t-content">
								...
								<i class="fa fa-caret-up text-success mr-0-5"></i><span>@lang('admin.custom.ffgg') {{$rides->count()}} @lang('admin.custom.fghh')</span>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4 col-md-6 col-xs-12">
						<div class="box box-block bg-white tile tile-1 mb-2">
							...
							<div class="t-content">
								...
								<i class="fa fa-caret-down text-danger mr-0-5"></i><span>@lang('admin.custom.ffgg') @if($cancel_rides == 0) 0.00 @else {{round($cancel_rides/$pagination->total,2)}}% @endif @lang('admin.custom.fghh')</span>
							</div>
						</div>
					</div>
															...
															<tr>
																...
																<td>
																	@if($ride->status != "CANCELLED")
																		<a class="text-primary" href="{{route('account.requests.show',$ride->id)}}"><span class="underline">@lang('admin.custom.dett')</span></a>
																	@else
