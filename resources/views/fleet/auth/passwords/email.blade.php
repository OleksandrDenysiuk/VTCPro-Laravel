            ...
            <div class="box b-a-0">
                ...
                {{ csrf_field() }}
                    ...
                    <div class="px-2 form-group mb-0">
                        <button type="submit" class="btn btn-purple btn-block text-uppercase">@lang('admin.custom.dispatcher_reset')</button>
                    </div>
                </form>
                <div class="p-2 text-xs-center text-muted">
                    <a class="text-black" href="{{ url('/fleet/login') }}"><span class="underline">@lang('admin.auth.login_here')</span></a>
                </div>
            </div>
        </div>
    </div>
