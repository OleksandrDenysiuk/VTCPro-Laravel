                    ...
                    <tr>
                        ...
                        @endif
                            ...
                            @if($provider->pending_documents() > 0 || $provider->service == null)
                                <a class="btn btn-danger btn-block label-right" href="{{route('fleet.provider.document.index', $provider->id )}}">@lang('admin.custom.attention') <span class="btn-label">{{ $provider->pending_documents() }}</span></a>
                            @else
                                <a class="btn btn-success btn-block" href="{{route('fleet.provider.document.index', $provider->id )}}">@lang('admin.custom.all_set')</a>
                            @endif
                        </td>
						                        <td>
                            @if($provider->service)
                            ...
                            <div class="input-group-btn">
                                ...
                                <a class="btn btn-danger btn-block" href="{{ route('fleet.provider.disapprove', $provider->id ) }}">@lang('admin.custom.Disable')</a>
                                @else
                                <a class="btn btn-success btn-block" href="{{ route('fleet.provider.approve', $provider->id ) }}">@lang('admin.custom.Enable')</a>
                                @endif
                                <button type="button" 
