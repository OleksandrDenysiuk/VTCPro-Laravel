        ...
        <div class="box box-block bg-white">
            ...
            <div class="row">
                        ...
                        <tbody>
                            ...
                            <tr>
                                    ...
                                    <form action="{{ route('fleet.provider.document.service', [$Provider->id, $service->id]) }}" method="POST">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
                                        <button class="btn btn-danger btn-large btn-block">@lang('admin.custom.delete')</a>
                                    </form>
                                    @endif
                                </td>
                            </tr>
                ...
                <form action="{{ route('fleet.provider.document.store', $Provider->id) }}" method="POST">
                    ...
                    <div class="col-xs-3">
                        <input type="text" required name="service_number" class="form-control" placeholder="@lang('admin.provides.plaque')">
                    </div>
                    <div class="col-xs-3">
                        <input type="text" required name="service_model" class="form-control" placeholder="@lang('admin.provides.model')">
                    </div>
                    @if( Setting::get('demo_mode', 0) == 0)
                    <div class="col-xs-3">
