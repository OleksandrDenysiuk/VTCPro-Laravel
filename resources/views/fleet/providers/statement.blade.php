				...
				<div class="col-lg-4 col-md-6 col-xs-12">
					<div class="box box-block bg-white tile tile-1 mb-2">
						...
						<div class="t-content">
							...
							<i class="fa fa-caret-up text-success mr-0-5"></i><span>Sur {{count($rides)}} de course</span>
						</div>
					</div>
				</div>
				@else
				...
				<div class="col-lg-4 col-md-6 col-xs-12">
					<div class="box box-block bg-white tile tile-1 mb-2">
						...
						<div class="t-content">
							...
							<i class="fa fa-caret-down text-danger mr-0-5"></i><span>Pour @if($cancel_rides == 0) 0.00 @else {{round($cancel_rides/count($rides),2)}}% @endif des courses</span>
						</div>
					</div>
				</div>
