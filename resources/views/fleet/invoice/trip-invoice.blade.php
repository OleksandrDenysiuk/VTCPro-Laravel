...
@else
<div id="view-invoice{{$trip->ids}}" class="modal" style="overflow: auto;">
    <form method="post" class="" action="{{url('fleet/trip-invoice-pdf')}}" style="margin:0" id="formDownloadPDF{{$trip->id}}">
        {{ csrf_field() }}
        <input type="hidden" name="trip_id" value="{{$trip->ids}}" />
        <input type="hidden" name="user_id" value="{{$trip->user_id}}" />

        <div class="modal-content text-center" style="width: 880px;">
            <div class="modal-header" style="height: 70px;">
                <a type="button" class="close" data-dismiss="modal" style="top: 17px; -webkit-appearance:none;">&times;</a>
                ...
                <a href="#" name="mile_submit" class="download_pdf" trip_id="{{$trip->ids}}" style="position: absolute;right: 47px;"><i class="fa fa-download fa-2x modal-icon-box" aria-hidden="true" style="color:#ccc;"></i></a>
            </div>
            <div>
...
{{--                                    <b class="">{{$trip->company_name}}</b> <br>--}}
{{--                                    <div style="width:80%;" class="">{{$trip->company_address}}</div>--}}
{{--                                    <div style="width:80%;" class="">{{$trip->company_zip_code}}</div>--}}
{{--                                    <div style="width:80%;" class="">{{$trip->company_city}}</div>--}}
...
{{--                        </tr>--}}
                        ...
                        <tr>
                            <td colspan="2">
                                <span style="font-size:14px;">{{$admin->note}}</span>
                            </td>
{{--                            <td align="right">--}}
