    ...
    <tr>
        <td colspan="3">
            ...
            <table width="100%">
                ...
                <tr>
                    <td><span style="font-size:20px;"><b class="">@lang('user.charged') - @if($trip->use_wallet == 0){{$trip->payment_mode}}@else @lang('admin.include.wallet') @endif</b></span></td>
                    <td></td>
