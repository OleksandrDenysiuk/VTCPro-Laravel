    ...
    <div id="wrapper">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a class="btn-outline" href="{{url('/register')}}">Inscrivez-vous pour réserver</a></li>
                                <li><a class="menu-btn" href="{{url('/provider/register')}}">Inscrivez-vous pour conduire</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-2 col-md-offset-1 support">
                 ...
                 <div class="col-xs-12 col-sm-12  col-md-6 sup-txt"><h2>Besoin d'aide ? Appelez nous</h2>
                     <div class="call-num">
<h3 class=""><a href="tel:{{ config('constants.contact_number', '+33667258426
')  }}"><!-- <span class="phone-icon"><i class="fa fa-3x fa-phone"></i></span> --> +33 (0)6 67 25 84 26</a> </h3>
                </div>
             </div>
...
')  }}</a> </h3>
    ...
    <div class="container pad-60"">
        <div class="row center">
            <h2>Obtenir l'application sur</h2>
            <p class="white">(Obtenez gratuitement les applications utilisateur et chauffeur sur Android et iOS)</p><br>
            <div class="">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">@lang('admin.dashboard.Wlc')</h4>
      </div>
      <div class="modal-body">
        <p>{{ config('constants.site_title','Tranxit') }} est disponible dans votre ville</p>
      </div>
