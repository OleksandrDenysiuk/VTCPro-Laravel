            ...
            <div class="cliproj-body">
                <div class="row">
                    ...
                    <div class="col-md-3 cliproj-bodybox">
                        ...
                        <div class="cliproj-bcont"><span class="label label-danger" style="padding:10px 20px">@if($ride->status == 'SCHEDULED') Pending @else @lang('admin.custom.Unpaid') @endif</span></div>
                    </div>
