<div class="sidebar-admin col-lg-3 col-md-3 col-sm-12">
    ...
    <div class="admin-nav-area">
        <div class="bigbutton"><a href="{{ url('/makearide') }}" target="_blank">@lang('admin.custom.make_ride')<span></span></a></div>
        <ul class="list-unstyled" style="outline: none;" tabindex="0">
            ...
            <li>
                <a href="{{ url('payment') }}">
                    ...
                    @lang('admin.custom.Payment')<i class="fa fa-chevron-right"></i>
                </a>
            </li>
            <li>
