                                                        ...
                                                        <div class="chbs-summary-price-element">
                                                            <div class="chbs-summary-price-element-total"
                                                                ...
                                                                <span class="total_fare"
                                                                      style="border-top: none;">00.00 {{config('constants.currency')}}</span>
                                                            </div>
                                                            <div class="chbs-summary-price-element-total"
                                                                 style="border-top: none;margin-top: 0;padding-top: 0;">
                                                                <span>@lang('admin.custom.book_promo')</span>
                                                                <span class="promocode_price"
                                                                      style="border-top: none; padding-top: 0;">00.00 {{config('constants.currency')}}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="chbs-layout-column-right">
...
<script>
    ...
    $(document).ready(function () {
                ...
                {{--        @if($user_type === "NORMAL")--}}
                {{--            var tempNormal = $('input[name="passengerNormalUserID"]').val();--}}
                {{--            $('input[name="passenger_id"]').val(tempNormal);--}}
                {{--        @endif--}}
                {{--        console.log($('input[name="passenger_id"]').val());--}}
    ...
    $("#booking_submit").click(function () {
        ...
        if(chbs_payment_id == 'WALLET') var use_wallet = 1;
        else use_wallet = 0;
