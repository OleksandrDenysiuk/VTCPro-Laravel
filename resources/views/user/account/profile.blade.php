                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        @if(Auth::user()->company_name)
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <div class="field-label"><label for="Facebook">@lang('admin.fleet.company_name')</label></div>
                                    <input  type="text" name="company_name"  style="height:55px !important;" class="form-control" required="" value="{{Auth::user()->company_name}}">
                                </div>
                            </div>
                        @endif
                        <div class="form-group row">
