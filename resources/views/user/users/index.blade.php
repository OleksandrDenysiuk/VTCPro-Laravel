...
@section('content')
    ...
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <a href="{{ route('passenger.create') }}" style="margin-left: 1em;" class="btn btn-primary pull-right"><i class="fa fa-plus" style="color: white;"></i> @lang('admin.include.add_new_user')</a>
            ...
            <div class="modal-content" style="width: 50%;">
                ...
                <div class="modal-body" style="padding: 15px 0px 15px 0px;">
                    <div id="sendbody" style="">
                        ...
                        <input type="number" required name="wallet_amount" id="wallet_amount" class="form-control" placeholder="" value="1" max="100" min="1">
                ...
                <div class="modal-footers">
                    ...
                    <button type="button" class="btn btn-danger" data-dismiss="modal" style="float: right;">@lang('admin.fleets.cancel')</button>
                </div>
                <!-- </form> -->
            </div>
...
<script type="text/javascript">
    jQuery.fn.DataTable.Api.register('buttons.exportData()', function(options) {
        if (this.context.length) {
            var jsonResult = $.ajax({
                url: "{{url('passenger')}}?download=all",
                data: {},
