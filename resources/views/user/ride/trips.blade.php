            ...
            <div class="col-sm-4 creative-right text-right" style="float: right;">
                <div class="pm-form" style="width: 100%;">
                    <form class="form-inline md-form form-sm">
                        <input class="form-control form-control" type="text" placeholder="@lang('admin.custom.Search_trips')..."
                               id="protbl-input">
                ...
                <div class="table-responsive">
                    <table class="table table-new projectspage clientside" data-pagination="true" data-page-size="5">
                        ...
                        <tr>
                            ...
                            <th>@lang('admin.point.status')</th>
                            <th>@lang('admin.custom.user_invoi')</th>
                        </tr>
                        </thead>
                        ...
                        @foreach($trips as $trip)
                            <tr>
                                ...
                                <td class="text-center"><span
                                        ...
                                        <span class="paidstatus paid">@lang('admin.custom.Paid')<span> @else <a href="{{url('/wallet')}}"
                                                                                          class="paidstatus unpaid">@lang('admin.custom.user_make')</a> @endif
                                </td>
                                <td class="viewinvoicebt text-center">
                                    <form method="get" class="invoiceForm" idx="{{$trip->id}}" action="#"
                                          style="margin:0">
                                        <button type="submit" class="btn outine">@lang('admin.custom.user_invoi')</button>
                                    </form>
                                </td>
                            </tr>
                            <tr class="hiddenRow">
                                            ...
                                            <div class="mytrip-right">
                                                <div class="whlbtn">
                                                    <button id="{{$trip->id}}" class="dispute" value="{{$trip->id}}">
                                                        @lang('admin.custom.Dispute')
                                                    </button>
                                                    <button id="{{$trip->id}}" class="lostitem" value="{{$trip->id}}">
                                                        @lang('admin.custom.LostItem')
                                                    </button>
                                                </div>
                    ...
                    if (data.lostitem.length != 0 && typeof (data.lostitem) !== "undefined" && data.lostitem != null) {
                        ...
                        if (data.sendBtn == "yes") {
                            $("#lostitemMsgBody").empty()
                                .append(` <div class="row dis">
                                    <div class="col-xs-3">
                                    <h2>@lang('admin.custom.Status_closed')</h2>
                                    </div>
                                    </div>
                                `);
                        } else {
                            $("#lostitemMsgBody").empty()
                                .append(`<div class="row dis">
                            <div class="col-xs-3">
                                    <h2>@lang('admin.dispute.dispute_comments')</h2>
                                </div>
                                <div class="col-xs-7">
                                <textarea class="dispdesc" name="msg" id="lostitemMsg" placeholder="@lang('admin.custom.type_message')"></textarea>
                            </div>
                            </div>
                            <input type="submit" name="submitbtn" class="submitbtn lostitemBtn" id="` + trip_id + `" value="OK">`);
                        }
                    } else {

                        $("#lostitemBody").empty()
                            .append(` <div class="row dis">
                                <h2 class="loshead">@lang('admin.custom.LostItem')</h2>
                                <div class="col-xs-3">
                                    <h2>@lang('admin.custom.Title')</h2>
                                </div>
                                <div class="col-xs-7">
                                <input type="text" class="disptitle" id="lostitemTitle" name="title" placeholder="@lang('admin.custom.Enter_title')"/>
                                </div>
                            </div>`);
                        $("#lostitemMsgBody").empty()
                            .append(`<div class="row dis">
                ...
                success: function (data) {
                    if (data.dispute.length != 0 && typeof (data.dispute) !== "undefined" && data.dispute != null) {
                        $("#disputeBody").find("#disputeReasonBody").empty().append(`<div class="col-xs-3">
                            <p class="loshead">@lang('admin.reason.reason')</p>
                            </div>
                            <div class="col-xs-7">
                        ...
                        if (data.sendBtn == "yes") {
                            ...
                            if (disputeMsgBody != "false") {
                             ...
                             <div class="col-xs-7">
                             <textarea class="dispdesc" name="msg" id="disputeMsg" placeholder="@lang('admin.custom.type_message')"></textarea>
                             </div>
                             </div>
                            <input type="submit" name="submitbtn" class="submitbtn disputeSendBtn" id="` + trip_id + `" value="OK">`);
                            } else {
                                $("#disputeMsgBody").empty();
                            }
                        }
                        ...
                        $("#disputeBody").empty()
                            .append(` <div class="row dis">
                            <h2 class="loshead">@lang('admin.custom.Dispute')</h2>
                            <div class="col-xs-3">
                                <h2>@lang('admin.reason.reason')</h2>
                            </div>
                            <div class="col-xs-7">
                            ...
                            <div class="col-xs-7">
                            <input type="text" class="disptitle" id="disputeTitle" name="title" placeholder="@lang('admin.custom.Enter_title')"/>
                            </div>
                        </div>`);
                        $("#disputeReason").empty();
                        ...
                        $("#disputeReason").append('<option value="others">@lang('admin.custom.offh')</option>');
                        $("#disputeMsgBody").empty()
