                    ...
                    @elseif($response->status == 'COMPLETED')
                        <form method="POST" action="{{url('/rate')}}">
                            ...
                            <div class="rate-review">
                                ...
                                <textarea class="form-control" name="comment" placeholder="@lang('admin.custom.type_message')"></textarea>
                            </div>
                            <button type="submit" class="full-primary-btn fare-btn">@lang('admin.custom.ddggs')</button>
                        </form>
                    @endif
                </div>
            </div>
