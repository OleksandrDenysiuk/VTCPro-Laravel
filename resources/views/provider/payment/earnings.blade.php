    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            <div class="box box-block bg-white">
                <h3>@lang('admin.provides.Total_Earning')</h3>
                <div class="datemenu">
				<span>
                    ...
                    <div class="col-lg-4 col-md-6 col-xs-12">
                        <div class="box box-block bg-white tile tile-1 mb-2">
                            ...
                            <div class="t-content">
                                ...
                                <i class="fa fa-caret-up text-success mr-0-5"></i><span>@lang('admin.custom.ffgg') {{$provider[0]->accepted->count()}} @lang('admin.custom.fghh')</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-xs-12">
                        <div class="box box-block bg-white tile tile-1 mb-2">
                            ...
                            <div class="t-content">
                                ...
                                <i class="fa fa-caret-down text-danger mr-0-5"></i><span>@lang('admin.custom.for') @if($provider[0]->cancelled->count() == 0) 0.00 @else {{round($provider[0]->cancelled->count()/count($provider[0]->accepted->count()),2)}}% @endif @lang('admin.custom.fghh')</span>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <!-- <td>
                                            ...
                                            <td>
                                                @if(in_array($each->id, $dispute_id))
                                                    <button class="Dispute" data-toggle="modal" data-target = "#distpute-{{$each->id}}">@lang('admin.custom.Dispute')</button>
                                                @else
                                                    <button data-id="{{$each->id}}" class="Dispute" data-toggle="modal" data-target="#myModal">@lang('admin.custom.Dispute')
                                                    </button>
                                                @endif
                                            </td>
                                        </tr>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title">@lang('admin.custom.Dispute')</h4>
                ...
                {{ csrf_field() }}
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row" style="margin-bottom: 15px;">
                            <div class="col-xs-3" style="padding-top: 6px;">@lang('admin.reason.reason')</div>
                            <div class="col-xs-9">
                        ...
                        <div class="row">
                            <div class="col-xs-3" style="padding-top: 6px;margin-top: 15px;">@lang('admin.custom.Title')</div>
                            <div class="col-xs-9">
                                <input type="text" class="form-control" style="margin-top: 15px;" id="disputeTitle" name="dispute_title" placeholder="@lang('admin.custom.Enter_title')">
                            </div>
                        </div>
                    </div>
                    <!-- Modal footer -->
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-secondary dispute-save">@lang('admin.custom.sendy') </button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-xs-3" style="padding-top: 6px;margin-top: 15px;">@lang('admin.reason.reason')</div>
                    ...
                    <!-- Modal footer -->
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-secondary" data-dismiss="modal">@lang('admin.payment.closs')</button>
                    </div>
                </div>
            </div>
        </div>
