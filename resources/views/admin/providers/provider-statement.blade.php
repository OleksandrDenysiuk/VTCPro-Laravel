    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            <div class="box box-block bg-white">
            	<h3>@lang('admin.include.provider_earnings')</h3>
															...
															<tr>
																...
																<td>
																	@if($provider->created_at)
																		<span class="text-muted">{{appDate($provider->created_at)}}</span>
																	@else
																	 	-
																	@endif
																</td>
																<td>
																	<a href="{{route('admin.statement', $provider->id)}}">@lang('admin.custom.ride_history')</a>
																</td>
															</tr>
														@endforeach
