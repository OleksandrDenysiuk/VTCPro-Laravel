            ...
            <div class="box box-block bg-white">
	            ...
	            <form class="form-horizontal" action="{{route('admin.send.push')}}" method="POST" role="form" id="create_push">
	            	...
	            	<div class="form-group row">
						...
						<div class="col-xs-10">
							<select class="form-control" name="send_to" onchange="switch_send(this.value)">
								<option value="ALL">@lang('admin.push.Use_Drivs')</option>
								<option value="USERS">@lang('admin.push.Userrs')</option>
								<option value="PROVIDERS">@lang('admin.push.Drivs')</option>
							</select>
						</div>
					</div>

					<div class="form-group row" id="for_users" style="display: none;">
						<label class="col-xs-2 col-form-label">@lang('admin.push.Usetions')</label>
						<div class="col-xs-5">
							<select class="form-control" name="user_condition" onchange="switch_user_condition(this.value);">
								<option value="">@lang('admin.push.Nnoon')</option>
								<option value="ACTIVE">@lang('admin.push.Actbbv')</option>
								<option value="LOCATION">@lang('admin.push.Wharin')</option>
								<option value="RIDES">@lang('admin.push.Mothan')</option>
						...
						<div class="col-xs-5" id="user_active" style="display: none;">
							<select class="form-control" name="user_active">
								<option value="HOUR">@lang('admin.push.Deure')</option>
								<option value="WEEK">@lang('admin.push.Lash')</option>
								<option value="MONTH">@lang('admin.push.Lash')</option>
							</select>
						</div>

						<div class="col-xs-5" id="user_rides"  style="display: none;">
							<input type="number" class="form-control" name="user_rides" placeholder="@lang('admin.push.Moanrid')">
						</div>

						<div class="col-xs-5" id="user_amount" style="display: none;">
							<input type="number" class="form-control" name="user_amount" placeholder="@lang('admin.push.Moant')">
						</div>

						<div class="col-xs-5" id="user_location" style="display: none;">
							<input type="text" class="form-control"  id="search_location" placeholder="@lang('admin.push.Laion')">
					...
					<div class="form-group row" id="for_providers" style="display: none;">
						<label class="col-xs-2 col-form-label">@lang('admin.push.Driveron')</label>
						<div class="col-xs-5">
							<select class="form-control" name="provider_condition" onchange="switch_provider_condition(this.value);">
								<option value="">@lang('admin.push.Servicedmo')</option>
								<option value="ACTIVE">@lang('admin.push.Actbbv')</option>
								<option value="LOCATION">@lang('admin.push.Wharin')</option>
								<option value="RIDES">@lang('admin.push.Mothan')</option>
						...
						<div class="col-xs-5" id="provider_rides"  style="display: none;">
							<input type="number" class="form-control" name="provider_rides" placeholder="@lang('admin.push.Moanrid')">
						</div>

						<div class="col-xs-5" id="provider_amount" style="display: none;">
							<input type="number" class="form-control" name="provider_amount" placeholder="@lang('admin.push.Moant')">
						</div>

						<div class="col-xs-5" id="provider_location" style="display: none;">
							<input type="text" class="form-control" id="search_provider_location" placeholder="@lang('admin.push.Laion')">
					...
					<div class="form-group row">
						...
						<div class="col-xs-10">
							<textarea maxlength="200" class="form-control" rows="3" name="message" required id="message" placeholder="@lang('admin.push.Essage')" ></textarea>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">@lang('admin.push.Noication')</h4>
      </div>
      <form>
      <div class="modal-body">
        ...
        <label>@lang('admin.push.Timesss')</label>
        <input value="{{date('H:i')}}" class="form-control" type="text" id="timepicker" placeholder="@lang('admin.push.Timesss')" name="schedule_time">

      </div>
      <div class="modal-footer">
        <button type="button" id="schedule_button" class="btn btn-default" data-dismiss="modal">@lang('admin.push.Schesh')</button>
      </div>
...
<script type="text/javascript">
	...
	$('#characterLeftDesc').text('@lang('admin.push.Cters')');

	$('#message').keyup(function () {
	    var max = 100;
	    var len = $(this).val().length;
	    if (len >= max) {
	        $('#characterLeftDesc').text(' @lang('admin.push.Reached')');
	    } else {
	        var ch = max - len;
	        $('#characterLeftDesc').text(ch + ' @lang('admin.push.Rslef')');
	    }
	});
