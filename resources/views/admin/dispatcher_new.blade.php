                ...
                <div class="clearfix container" style="margin-top: 50px;">
                    <div class="row chbs-main chbs-booking-form-id-10007 chbs-clear-fix chbs-width-1220"
                        ...
                        <form name="chbs-form">
                            ...
                            <div class="chbs-main-content chbs-clear-fix">
                                ...
                                <div class="chbs-main-content-step-1">
                                            ...
                                            <div class="chbs-tab chbs-box-shadow ui-tabs ui-widget ui-widget-content ui-corner-all">
                                                <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all"
                                                    ...
                                                    <li id="ui-id-li-2" data-id="1"
                                                        class="ui-state-default ui-corner-top ui-tabs-active" role="tab"
                                                        tabindex="-1" aria-controls="panel-2" aria-labelledby="ui-id-2"
                                                    ...
                                                    <li id="ui-id-li-3" data-id="2"
                                                        class="ui-state-default ui-corner-top" role="tab" tabindex="-1"
                                                ...
                                                <div id="panel-1" aria-labelledby="ui-id-1"
                                                    ...
                                                    <div class="chbs-clear-fix" id="panle_1_pickuparea">
                                                        ...
                                                        <div class="chbs-form-field chbs-form-field-width-50">
                                                            ...
                                                            <input type="text" name="chbs_pickup_date_service_type_1"
                                                                   value="" id="start_travelldate" class="chbs-datepicker"
                                                                   size="10">
                                                        </div>


                                                        <div class="chbs-form-field chbs-form-field-width-50">
                                                            <label>@lang('admin.custom.pick_time')</label>
                                                            <input type="text" autocomplete="off"
                                                                   name="chbs_pickup_time_service_type_1"
                                                                   class="chbs-timepicker" id="start_travelltime" value="">
                                                    ...
                                                    <div class="chbs-clear-fix" id="return_date" style="display: none">

                                                        <div class="chbs-form-field chbs-form-field-width-50">
                                                            <label class="chbs-form-field-label">@lang('admin.custom.book_return_date')</label>
                                                            <input type="text" autocomplete="off"
                                                                   name="chbs_return_date_service_type_2"
                                                                   class="chbs-datepicker hasDatepicker" value=""
                                                                   id="return_travelldate" size="10">
                                                        </div>

                                                        <div class="chbs-form-field chbs-form-field-width-50">
                                                            <label>@lang('admin.custom.book_pick_time')</label>
                                                            <input type="text" autocomplete="off"
                                    ...
                                    <div class="chbs-clear-fix chbs-main-content-navigation-button">
                                        <a href="#" class="chbs-button chbs-button-style-1 chbs-button-step-next">
                                            @lang('admin.custom.book_choose') <span class="chbs-meta-icon-arrow-horizontal-large"></span>
                                        </a>
                                    </div>
                                </div>

                                <div class="chbs-main-content-step-2">
                                    <div class="chbs-layout-25x75 chbs-clear-fix" style="position: relative;">
                                        <div class="chbs-layout-column-left hidden-sm hidden-xs hidden-ml"
                                            ...
                                            <div class="chbs-summary">
                                                ...
                                                <div class="chbs-summary-field return-trip chbs-hidden">
                                                    <div class="chbs-summary-field-name">@lang('admin.custom.book_from') @lang('admin.custom.book_return_trip')</div>
                                                    <div class="chbs-summary-field-value return_from_to_address"></div>
                                                </div>
                                                <div class="chbs-summary-field">
                                                    <div class="chbs-summary-field-name">@lang('admin.custom.book_pick_time')</div>
                                                    <div class="chbs-summary-field-value booking_date"></div>
                                                </div>
                                                <div class="chbs-summary-field returnDateScope chbs-hidden">
                                                    <div class="chbs-summary-field-name">@lang('admin.custom.book_pick_date')</div>
                                                    <div class="chbs-summary-field-value return_date"></div>
                                                </div>
                                                <div class="chbs-summary-field">
                                                    <div class="chbs-layout-50x50 chbs-clear-fix">
                                                        <div class="chbs-layout-column-left">
                                                            <div class="chbs-summary-field-name">@lang('admin.custom.book_distance')</div>
                                                        ...
                                                        <div class="chbs-layout-column-right">
                                                            <div class="chbs-summary-field-name">@lang('admin.custom.book_time')</div>
                                                            <div class="chbs-summary-field-value">
                                            ...
                                            <div class="chbs-summary-price-element">
                                                <div class="chbs-summary-price-element-total" style="border-top: none;">
                                                    <span>Total</span>
                                                    <span class="total_fare" style="border-top: none;">00.00 {{config('constants.currency')}}</span>
                                                </div>
                                                <div class="chbs-summary-price-element-total" style="border-top: none;margin-top: 0;padding-top: 0;">
                                                    <span>@lang('admin.custom.book_promo')</span>
                                                    <span class="promocode_price" style="border-top: none; padding-top: 0;">00.00 {{config('constants.currency')}}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="chbs-layout-column-right">
                                            <div class="chbs-vehicle-filter chbs-box-shadow chbs-clear-fix hidden-sm hidden-xs">
                                                ...
                                                <div class="chbs-form-field chbs-form-field-width-33">
                                                    ...
                                                    <div>
                                                        <select name="chbs_vehicle_passenger_count" id="ui-id-passenger"
                                                                style="display: none;">
                                                ...
                                                <div class="chbs-form-field chbs-form-field-width-33"
                                                    ...
                                                    <select name="chbs_vehicle_bag_count" id="ui-id-suitcase"
                                                            style="display: none;">
                                                        <option value="1" selected="selected">1</option>
                                                        <option value="2">2</option>
                                                        <option value="3">3</option>
                                                ...
                                                <div class="chbs-form-field chbs-form-field-width-33"
                                                    ...
                                                    <select name="chbs_vehicle_category" id="ui-id-vehicle-type"
                                                            style="display: none;">
                                ...
                                <div class="chbs-main-content-step-3">
                                    <div class="chbs-layout-25x75 chbs-clear-fix" style="position: relative;">
                                        ...
                                        <div class="chbs-layout-column-left hidden-sm hidden-xs" style="">
                                            <div class="chbs-summary">
                                                <div class="chbs-summary-header">
                                                    <h4>@lang('admin.custom.book_sum')</h4>
                                        ...
                                        <div class="chbs-layout-column-right">
                                            ...
                                            <div class="chbs-client-form">
                                                <div class="chbs-client-form-sign-up">
                                                    ...
                                                    <div class="chbs-box-shadow">
                                                        ...
                                                        <div class="chbs-clear-fix">
                                                            <div class="chbs-clear-fix">
                                                                <div class="chbs-form-field">
                                                                    ...
                                                                    <textarea name="chbs_comments"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="chbs-clear-fix">
                                                        ...
                                                        <div class="chbs-clear-fix">
                                                            {{--                                                            <label class="chbs-form-label-group passenger-select">--}}
                                                            {{--                                                                <span class="chbs-form-checkbox">--}}
                                                            {{--                                                                    <span class="chbs-meta-icon-tick"></span>--}}
                                                            {{--                                                                </span>--}}
                                                            <input name="chbs_client_billing_detail_enable"
                                                                   type="hidden" value="1">
                                                            {{--                                                                @lang('admin.custom.book_have')--}}
                                                            {{--                                                            </label>--}}
                                                            <label class="chbs-form-label-group pro-select">
                                                                    <span class="chbs-form-checkbox-custom">

                                                                    </span>
                                                                <input name="chbs_client_user_pro_enable"
                                                                       type="hidden" value="0">
                                                                Pro
                                                            </label>
                                                        </div>
                                                        <div id="extra-fields">
                                                            ...
                                                            <div class="chbs-clear-fix chbs-hidden"
                                                                 id="user_pro_details">
                                                                <div class="chbs-form-field chbs-form-field-width-50">
                                                                    <label>@lang('admin.custom.book_company')</label>
                                                                    <input name="chbs_client_billing_detail_company_name_passenger"
                                                                           type="text"
                                                                           value="">
                                                                </div>
                                                                <div class="chbs-form-field chbs-form-field-width-50">
                                                                    <label>@lang('admin.custom.book_address')</label>
                                                                    <input type="text" autocomplete="off"
                                                                           name="chbs_client_billing_detail_address_passenger"
                                                                           value=""
                                                                           id="chbs_client_billing_detail_address_passenger"
                                                                           placeholder="@lang('admin.custom.book_enter_lo')">
                                                                    <input type="hidden"
                                                                           name="location_coordinate_passenger"
                                                                           id="address"
                                                                           value="">
                                                                </div>
                                                            </div>
                                            ...
                                            <ul class="chbs-payment chbs-list-reset">
                                                @if(Config::get('constants.cash') == 1)
                                                    <li>
                                                        <a class="chbs-payment-type-1" data-payment-id="CASH">
                                                ...
                                                @if(Config::get('constants.card') == 1)
                                                    <li>
                                                        <a class="chbs-payment-type-2" data-payment-id="CARD">
                                                            <span class="chbs-meta-icon-tick"></span>
                                                        </a>
                                                    </li>
                                                @endif
                                    ...
                                    <div class="chbs-clear-fix chbs-main-content-navigation-button">
                                        ...
                                        <a href="#" class="chbs-button chbs-button-style-1 chbs-button-step-next">
                                            @lang('admin.custom.book_book_sum') <span class="chbs-meta-icon-arrow-horizontal-large"></span>
                                        </a>
                                    </div>
                                </div>
                                <div class="chbs-main-content-step-4">
                                    <div class="chbs-layout-33x33x33 chbs-clear-fix">
                                        ...
                                        <div class="chbs-layout-column-left">
                                            <div class="chbs-summary">
                                                ...
                                                <div class="chbs-summary-field">
                                                    ...
                                                    <div class="chbs-summary-field-value" id="chbs_comment"></div>
                                                </div>
                                                <div id="passenger_info">
                                                    <div class="chbs-summary-field">
                                                        <div class="chbs-layout-50x50 chbs-clear-fix">
                                                            <div class="chbs-layout-column-left">
                                                                <div class="chbs-summary-field-name">@lang('admin.custom.book_first')</div>
                                                                <div class="chbs-summary-field-value"
                                                                     id="first_name_passenger"></div>
                                                            </div>
                                                            <div class="chbs-layout-column-right">
                                                                <div class="chbs-summary-field-name">@lang('admin.custom.book_last')</div>
                                                                <div class="chbs-summary-field-value"
                                                    ...
                                                    <div class="chbs-summary-field country_code_passenger">
                                                        <div class="chbs-layout-column-right">
                                                            <div class="chbs-summary-field-name">@lang('admin.custom.book_country')</div>
                                                            <div class="chbs-summary-field-value"
                                                    ...
                                                    <div class="chbs-summary-field">
                                                        <div class="chbs-summary-field-name">@lang('admin.custom.book_number')</div>
                                                        <div class="chbs-summary-field-value"
                                                             id="phone_number_passenger">
                                                        </div>
                                                    </div>
                                                    <div class="chbs-summary-field">
                                                        <div class="chbs-summary-field-name">@lang('admin.custom.book_email')</div>
                                                        <div class="chbs-summary-field-value"
                                            ...
                                            <div class="chbs-summary">
                                                ...
                                                <div class="chbs-summary-field">
                                                    ...
                                                    <div class="chbs-summary-field-value" id="payment_setting"></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="chbs-layout-column-center">
                                            ...
                                            <div class="chbs-summary">
                                                <div class="chbs-summary-header">
                                                    <h4>@lang('admin.custom.ride_details')</h4>
                                                ...
                                                <div class="chbs-summary-field returnDateScope chbs-hidden">
                                                    <div class="chbs-summary-field-name">@lang('admin.custom.book_return_date')</div>
                                                    <div class="chbs-summary-field-value return_date"></div>
                                                </div>
                                                <div class="chbs-summary-field">
                                                    <div class="chbs-layout-50x50 chbs-clear-fix">
                                        ...
                                        <div class="chbs-layout-column-right">
                                            ...
                                            <div class="chbs-summary-price-element">
                                                ...
                                                <div class="chbs-summary-price-element-total" style="border-top: none;margin-top: 0px;padding-top: 0px;">
                                                    <span>@lang('admin.custom.book_promo')</span>
                                                    <span class="promocode_price" style="border-top: none;padding-top: 0px;">00.00 €</span>
                                                </div>
                                                <div class="chbs-summary-price-element-total" style="border-top: none;margin-top: 0px;padding-top: 0px;border-bottom: 5px solid;padding-bottom: 10px;">
                                                    <span>@lang('admin.custom.book_tax') ({{config('constants.tax_percentage')}}%)</span>
                                    ...
                                    <div class="chbs-clear-fix chbs-main-content-navigation-button">
                                        ...
                                        <a href="#" class="chbs-button chbs-button-style-1 chbs-button-step-next"
                                           id="booking_submit">
                                            @lang('admin.custom.book_book_now') <span class="chbs-meta-icon-arrow-horizontal-large"></span>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <input data-value="0" name="chbs_base_location_distance" type="hidden" value="0">
                            <input data-value="0" name="chbs_base_location_duration" type="hidden" value="0">

                            <input data-value="0" name="chbs_base_location_return_distance" type="hidden" value="0">
                            <input data-value="0" name="chbs_base_location_return_duration" type="hidden" value="0">
                            <input data-value="10007" name="chbs_booking_form_id" type="hidden" value="10007">
                            ...
                            <input data-value="0" name="passenger_id" type="hidden" value="0">
                            ...
                            <input id = "tax_percentage" type="hidden" value="{{config('constants.tax_percentage')}}">

                            <input name="currency" type="hidden" value="{{config('constants.currency')}}">
                        </form>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            // console.log(JSON.parse(value)['formatted_address']);
            var bookingForm = new ChauffeurBookingForm($('#chbs_booking_form_C5961B482E2E1E6A202D2999585137FB'), {
            ...
            $(".chbs-form-checkbox-custom").click(function () {
                $(this).toggleClass("chbs-state-selected-custom");
                $("#user_pro_details").toggleClass("chbs-hidden");
                var user_pro = $('input[name="chbs_client_user_pro_enable"]');
                var values = user_pro.val() == 1 ? 0 : 1;
                user_pro.val(values);
            });
                    ...
                    if (first_name == choices[i]) {
                        $.ajax({
                            ...
                            success: function (res) {
                                ...
                                $('input[name="chbs_client_billing_detail_company_name_passenger"]').val(res.company_name);
                                $('input[name="chbs_client_billing_detail_address_passenger"]').val(res.company_address);
                                //whether show wallet function or not
                                bookingForm.showUseWallet();
                            }
                        })
                    }
            });
        ...
        //     if (window.scrollY > 200 && screen.width > 768 && flag === false) {
        //
        //         flag = true;
        //         $(".chbs-layout-25x75.chbs-clear-fix>div:first-child").html("<div class='chbs-layout-column-left is_stuck' style= 'position: fixed; top: 30px; width: 264px;'>" + $(".chbs-layout-25x75.chbs-clear-fix>div:first-child").html() + "</div>");
        //         $(".chbs-layout-25x75.chbs-clear-fix>div:first-child").removeClass("chbs-layout-column-left");
        //         $(".chbs-layout-25x75.chbs-clear-fix>div:first-child").attr("style", "position:static;  width:264px; height:630px; display:block;vertical-align:baseline; float:left;");
        //
        //
        //     }
        //     if ($(document).height() - window.scrollY < 700) {
        //         $(".chbs-layout-column-left.is_stuck").attr("style", "position: absolute; top: auto; width: 264px; bottom: 0px;");
        //     } else {
        //         $(".chbs-layout-column-left.is_stuck").attr("style", "position: fixed; top: 30px; width: 264px;");
        //     }
        //     if (flag && window.scrollY < 200 || screen.width < 768) {
        //         flag = false;
        //         console.log("200 is less");
        //         $(".chbs-layout-25x75.chbs-clear-fix>div:first-child").html($(".chbs-layout-column-left.is_stuck").html());
        //         $(".chbs-layout-25x75.chbs-clear-fix>div:first-child").addClass("chbs-layout-column-left");
        //         $(".chbs-layout-25x75.chbs-clear-fix>div:first-child").attr("style", "");
        //     }
        // });
        ...
        $("#booking_submit").click(function () {
            ...
            var passenger_company_name = $('input[name="chbs_client_billing_detail_company_name_passenger"]').val();
            ...
            var passenger_address = $('input[name="chbs_client_billing_detail_address_passenger"]').val();
            ...
            var data = {
                ...
                passenger_company_name: passenger_company_name,
            ...
            $.ajax({
                url: '/admin/submitBookingDataforDispatcher',
                method: 'POST',
                data: data,
    ...
    <script src="{{asset('asset/booking_form/js/jquery.hauffeurBookingForm.js')}}"></script>
