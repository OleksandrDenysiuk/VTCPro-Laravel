            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        @if($request->status == 'SCHEDULED')
                            <!-- <a class="btn btn-info assign_provider" href="javascript:void(0);" >@lang('admin.custom.assign_provider')</a> -->
                                <!-- <a class="btn btn-info assign_fleet" style="margin-left:10px; background-color:#2fb920" href="javascript:void(0);" >@lang('admin.custom.assign_fleet')</a> -->
                            @endif
                        </div>
                    </div>
                </div>
