...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            @endif
            <h5 class="mb-1"> @if($from_date) From {{appDate($from_date)}} @endif @if($to_date) To {{appDate($to_date)}} @endif </h5>
            @include('common.date_filter', ['action' => 'admin.requests.dispatcher'])
            @if(count($requests) != 0)
                    ...
                    <tr>
                        ...
                        <td width="200">
                            ...
                            <div class="input-group-btn" style="left:5px; display:inline-block">
                                <a href="#" class="btn btn-info downloadpdf" idx="{{$request->id}}" style="background-color:#b531ba;border-color:#b531ba;"><i class=""></i>@lang('admin.provides.inv')</a>
                            </div>
                            @endif
                        </td>
                    </tr>
