...
<div class="content-area py-1">
    <div class="container-fluid">
        ...
        <div class="box box-block bg-white">
            ...
            <a href="/admin/scheduled" id="back_btn" class="btn btn-default pull-right" style="margin-top: -50px;">
                ...
                <div class="col-md-6">
                    <dl class="row">
                        ...
                        <dd class="col-sm-6" style="font-size: 17px;border-top: 2px solid;width: 11%;padding-top: 10px;">
                            ...
                            $request->payment->toll_charge + $request->payment->waiting_amount + $request->payment->peak_amount) }}
                        </dd>
                        <dt class="col-sm-6" style="margin-bottom: 17px;border-bottom: 2px solid;padding-bottom: 10px;">@lang('admin.request.tax_price') :</dt>
                        <dd class="col-sm-6" style="border-bottom: 2px solid;width: 11%;padding-bottom: 10px;">{{ currency($request->payment->tax) }}</dd>
                ...
                <div class="col-md-6">
                    ...
                    <dl>
                        ...
                        <dd class="col-sm-6">
                            ...
                            @elseif($request->user->user_type == 'NORMAL' && $request->user->company_name !='')
                        ...
                        <dd class="col-sm-6">
                            {{ App\UserRequests::getWayPointAddress($request->way_points)  }}
