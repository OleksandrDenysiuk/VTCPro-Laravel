    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            ...
            <div class="box box-block bg-white">
                ...
                <table class="table table-striped table-bordered dataTable" id="table-6">
                    ...
                    @foreach($requests as $index => $request)
                        <tr>
                            ...
                            <td>
                                @if($request->paid)
                                    @lang('admin.payment.paidds')                                @else
                            ...
                            <td>
                                {{currency_number($request->total_price)}} &euro;
                            </td>
                            ...
                            <td>
                                <div class="input-group-btn">
                                  ...
                                  <ul class="dropdown-menu">
                                    <li>
                                    <a href="{{ route('admin.requests.show', $request->id) }}" class="btn btn-default"><i class="fa fa-search"></i> @lang('admin.payment.moredsq')</a><br>
                                    <a href="{{ route('admin.assign.provider', $request->id) }}" class="btn btn-default assign_provider" req-id="{{$request->id}}"><i class="fa fa-taxi"></i> @lang('admin.custom.assign_provider')</a><br>
                                    <a href="{{ route('admin.assign.fleet', $request->id) }}" class="btn btn-default assign_fleet" class="btn btn-default" req-id="{{$request->id}}"><i class="fa fa-modx"></i> @lang('admin.custom.assign_fleet')</a><br>
                                    <a href="{{ route('admin.assign.cancel', $request->id) }}" class="btn btn-default assign_fleet" class="btn btn-default" req-id="{{$request->id}}"><i class="fa fa-times"></i> @lang('admin.custom.cancel_assign')</a>
                                    </li>
                                  </ul>
                ...
                @else
                    <h6 class="no-result">@lang('admin.custom.reds')
</h6>
                @endif
            </div>
...
<script type="text/javascript">
    ...
    // for new button
    $('#table-6').on('click', '.vocher', function(){
        var id = $(this).attr('rid');
        $('#table-6 .pdf-download' + id).submit();
    });
