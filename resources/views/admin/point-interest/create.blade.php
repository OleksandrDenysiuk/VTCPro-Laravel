                                ...
                                <div class="col-md-6 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" type="text" title="Enter the zone address"
                                               ...
                                               placeholder="@lang('admin.point.Enter_location')" autocomplete="off">
                                    </div>
                                    ...
                                    <div class="row" id="shape_save_area" style="display: none;">
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" name="shape_name"
                                                                     id="shape_name" placeholder="@lang('admin.poi.Shape_name')">
                                        </div>
                                        <div class="col-md-4">
                                ...
                                <td>
                                    <ul>
                                        <li><label><input type="checkbox" id="select_all" style="margin-right: 5px;"/>
                                                @lang('admin.poi.All_vehicles')</label></li>
                            ...
                            <tr>
                                <th scope="row">
                                    <label for="quickcab_geofence_direction"
                                           class="col-xs-10 col-form-label">@lang('admin.poi.Direction')</label>
                                </th>
                                <td>
                                    <select class="form-control" name="quickcab_geofence_direction"
                                            id="quickcab_geofence_direction" style="padding: 6px;">
                                        <option value="1" selected="">@lang('admin.poi.One_direction')
                                        </option>
                                        <option value="2">@lang('admin.poi.Both_directions')
                                        </option>
                                    </select>
