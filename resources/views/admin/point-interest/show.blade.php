    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            <div class="box box-block bg-white">
                ...
                <a href="{{ route('admin.pointinterest.edit', $point_interest->id) }}" class="btn btn-default pull-right">
                    <i class="fa fa-pencil"></i> @lang('admin.poi.edit')
                </a>
                <h5 style="margin-bottom: 2em;">@lang('admin.point.show_Point_Interest')</h5>

                <form class="form-horizontal" action="{{route('admin.pointinterest.store')}}" method="POST" role="form">
                    {{ csrf_field() }}
                    ...
                    <div class="inside">
                        <table class="form-table">
                            ...
                            <tr>
                                <th scope="row">
                                    <label for="quickcab_geofence_ignore_surge_pricing_rule"
                                           class="col-xs-10 col-form-label">@lang('admin.point.ignore_surge_price_rules')</label>
                                </th>
                                <td>
                                    ...
                                    <p class="description">@lang('admin.point.ignore_explain')</p>
                                </td>
                            </tr>
                            </tbody>
                            ...
                            <tr>
                                <th scope="row">
                                    <label for="quickcab_geofence_fixed_price_amount" class="col-xs-10 col-form-label">@lang('admin.point.fixed_price')</label>
                                </th>
                                <td>
                            ...
                            <tr>
                                <th scope="row">
                                    <label for="quickcab_geofence_vehicle_ids"
                                           class="col-xs-10 col-form-label">@lang('admin.point.Vehicle')</label>
                                </th>
                                <td>
                                    <ul>
                                    ...
                                    <p class="description">@lang('admin.point.which_vehicule')</p>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">
                                    <label for="quickcab_geofence_direction"
                                           class="col-xs-10 col-form-label">@lang('admin.point.Direction')</label>
                                </th>
                                <td>
                                    @if($point_interest->direction_state === 1) <span style="color: green;">@lang('admin.point.One_direction')</span>
                                    @elseif($point_interest->direction_state === 2)<span style="color: red;">@lang('admin.point.Both_directions')</span>
                                    @endif
                                    <p class="description">@lang('admin.point.rule_apply')</p>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">
                            ...
                            <div class="row">
                                <div class="col-xs-6 col-sm-3 col-md-2">
                                    <a href="{{ route('admin.pointinterest.index') }}"
                                       class="btn btn-danger">@lang('admin.provides.bkk')</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        function get_polygon_cordinates(polygon)
        {
            ...
            for (var i = 0; i < polygon.getPath().getLength(); i++) {
                ...
                bounds.extend(new google.maps.LatLng(lat_lng[1], lat_lng[0]));
