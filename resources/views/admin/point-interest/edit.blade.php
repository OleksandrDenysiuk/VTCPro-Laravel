    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            <div class="box box-block bg-white">
                ...
                <form class="form-horizontal" action="{{route('admin.pointinterest.update',$point_interest->id)}}" method="POST" role="form" onsubmit="return validateGeofence();">
                    {{ csrf_field() }}
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            <th scope="row" style="padding: 20px 0px 20px 17px;width: 15%">
                                <label for="quickcab_geofence_fixed_price_amount" class="col-form-label">@lang('admin.point.name')/label>
                            </th>
                            <td style="padding: 15px 30px;">
                                <input class="form-control" type="text" value="{{ $point_interest->rule_name }}" name="type" required style="width: 60%;"
                    ...
                    <div class="form-group row">
                        ...
                        <input id="bound" name="bound"  type="hidden" value="({{json_decode($point_interest->start_coordinate)->lat}},{{json_decode($point_interest->start_coordinate)->lng}})">
                        <input id="bound1" name="bound1"  type="hidden" value="({{json_decode($point_interest->dest_coordinate)->lat}},{{json_decode($point_interest->dest_coordinate)->lng}})">
                    </div>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="new_input_field row" style="width: 100%">
                                <div class="col-md-6 col-xs-12">
                                    <textarea id="geofence_latlng" name="geofence_latlng" style="display:none;width: 100%;">{{$point_interest->start_mapdata_origin}}</textarea>
                                    <textarea id="geofence_latlng_dispatcher" name="geofence_latlng_dispatcher"  style="display:none;width: 100%;">{{$point_interest->start_mapdata_latlng}}</textarea>
                                    <h2>@lang('admin.point.Location_one')</h2>
                                    ...
                                    <div id="floating-panel">
                                        <button type="button" class="btn btn-danger mr-15 col-lg-3 col-md-5 col-sm-5 col-xs-12" onclick="removePolygon();"
                                                ...
                                                name="remove_polygon" id="remove_polygon">@lang('admin.point.Remove_polygon')
                                        </button>
                                        <button type="button" class="btn btn-success mr-15 col-lg-2 col-md-5 col-sm-5 col-xs-12" title="Save Shape"
                                                ...
                                                style="margin-right: 15px;">@lang('admin.point.Save_shape')
                                        </button>
                                        <button type="button" class="btn btn-primary mr-15 col-lg-3 col-md-5 col-sm-5 col-xs-12" onclick="shapeImport();"
                                                ...
                                                name="import_shape" id="import_shape">@lang('admin.point.Import_shape')
                                        </button>
                                    ...
                                    <div class="row" id="shape_save_area" style="display: none;">
                                        <div class="col-md-4 col-xs-8"><input type="text" class="form-control" name="shape_name"
                                                                     id="shape_name" placeholder="Shape Name"></div>
                                        <div class="col-md-4 col-xs-4">
                                            <button type="button" class="btn btn-primary mr-15" title="Save"
                                                    data-toggle="tooltip" name="shape_save" id="shape_save" onclick="shapeSaveVal(1);">@lang('admin.poi.Save')
                                            </button>
                                        </div>
                                    </div>
                                    <div class="row" id="shape_import_area" style="display: none;">
                                        <div class="col-md-4 col-xs-8">
                                            <select class="form-control" id="import_shape_val" name="import_shape_val"
                                                    style="padding: 6px;">
                                                {{--  <option disabled="" selected="" value="0">@lang('admin.poi.Select_shape')...</option>--}}
                                        ...
                                        <div class="col-md-4 col-xs-8">
                                            <button type="button" class="btn btn-primary mr-15" title="Import"
                                                    ...
                                                    onclick="import_shape_area(1);">@lang('admin.poi.Import')
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <textarea id="geofence_other_latlng" name="geofence_other_latlng"
                                              style="display:none;width: 100%;">{{$point_interest->dest_mapdata_origin}}</textarea>
                                    <textarea id="geofence_other_latlng_dispatcher" name="geofence_other_latlng_dispatcher"
                                              style="display:none;width: 100%;">{{$point_interest->dest_mapdata_latlng}}</textarea>
                                    <h2>@lang('admin.point.Location_two')</h2>
                                    <div class="form-group">
                                        <input class="form-control" type="text" title="Enter the zone address"
                                    ...
                                    <div id="floating-panel">
                                        <button type="button" class="btn btn-danger mr-15 col-lg-3 col-md-5 col-sm-5 col-xs-12" onclick="removePolygon1();"
                                                title="Remove polygon" data-toggle="tooltip"
                                                name="remove_polygon" id="remove_polygon">@lang('admin.point.Remove_polygon')
                                        </button>
                                        <button type="button" class="btn btn-success mr-15 col-lg-2 col-md-5 col-sm-5 col-xs-12" title="Save Shape"
                                                data-toggle="tooltip"
                                                name="save_shape_1" id="save_shape_1" onclick="shapeSave1();">@lang('admin.point.Save_shape')
                                        </button>
                                        <button type="button" class="btn btn-primary mr-15 col-lg-3 col-md-5 col-sm-5 col-xs-12" onclick="shapeImport1();"
                                                title="Import Shape" data-toggle="tooltip"
                                                name="import_shape" id="import_shape">@lang('admin.point.Import_shape')
                                        </button>
                                        <button type="button" class="btn btn-primary mr-15 col-lg-2 col-md-5 col-sm-5 col-xs-12" onclick="poiCategory1();"
                                                title="POI Category" data-toggle="tooltip"
                                                name="poi_category"
                                                id="poi_category">@lang('admin.poi.poi_category')</button>
                                    </div>
                                    <div class="row" id="shape_save_area_1" style="display: none;">
                                        ...
                                        <div class="col-md-4 col-xs-4">
                                            <button type="button" class="btn btn-primary mr-15" title="Save"
                                                    data-toggle="tooltip" name="shape_save" id="shape_save" onclick="shapeSaveVal(2);">@lang('admin.poi.Save')
                                            </button>
                                        </div>
                                    </div>
                                    <div class="row" id="shape_import_area_1" style="display: none;">
                                        <div class="col-md-4 col-xs-8">
                                            <select class="form-control" id="import_shape_val_1" name="import_shape_val_1"
                                                    style="padding: 6px;">
                                                {{--                                                <option disabled="" selected="">@lang('admin.poi.Select_shape')...</option>--}}
                                                @foreach ($shape_data as $val)
                                                    <option value="{{$val->id}}">{{$val->title}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-4 col-xs-4">
                                            <button type="button" class="btn btn-primary mr-15" title="Import" onclick="import_shape_area(2);"
                                                    data-toggle="tooltip" name="shape_import1" id="shape_import1">@lang('admin.poi.Import')
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div class="inside">
                        <table class="form-table">
                            ...
                            <tr>
                                <th scope="row">
                                    <label for="quickcab_geofence_ignore_surge_pricing_rule"
                                           class="col-xs-10 col-form-label">@lang('admin.poi.ignore_surge_price_rules')</label>
                                </th>
                                <td>
                                    <input name="ignore_surge_pricing_rule" type="checkbox"
                                           id="ignore_surge_pricing_rule" value="1" @if($point_interest->ignore_surge_price === 1) checked @endif
                                           class="quickcab__geofence--override-surge-price">
                                    <p class="description">@lang('admin.poi.ignore_explain')</p>
                                </td>
                            </tr>
                            </tbody>
                            ...
                            <tr>
                                <th scope="row">
                                    <label for="quickcab_geofence_fixed_price_amount" class="col-xs-10 col-form-label">@lang('admin.poi.fixed_price')</label>
                                </th>
                                <td>
                            ...
                            <tr>
                                <th scope="row">
                                    <label for="quickcab_geofence_vehicle_ids"
                                           class="col-xs-10 col-form-label">@lang('admin.poi.Vehicle')</label>
                                </th>
                                <td>
                                    <ul>
                                        <li><label><input type="checkbox" id="select_all" style="margin-right: 5px;"/>@lang('admin.poi.All_vehicles')</label></li>
                                    ...
                                    <p class="description">@lang('admin.poi.which_vehicule')</p>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">
                                ...
                                <td>
                                    <select class="form-control" name="quickcab_geofence_direction"
                                        ...
                                        <option value="1"  @if($point_interest->direction_state === 1) selected @endif>@lang('admin.poi.One_direction')
                                        </option>
                                        <option value="2"  @if($point_interest->direction_state === 2) selected @endif>@lang('admin.poi.Both_directions')
                                        </option>
                                    </select>
                                    <p class="description">@lang('admin.poi.rule_apply')</p>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">
                                ...
                                <td>
                                    <select class="form-control" id="status" name="status" style="padding: 6px;">
                                        <option value="1" @if($point_interest->status === 1) selected @endif>@lang('admin.poi.active')</option>
                                        <option value="0" @if($point_interest->status === 0) selected @endif>@lang('admin.poi.inactive')</option>
                                    </select>
                                </td>
                            </tr>
                            </tbody>
...
// console.log({"type":"FeatureCollection","features":[]});
            ...
            else
            {
                ...
                // var triangleCoords = [
                //     {lng: 2.34534471608583, lat: 48.86403950804247}, // north west
                //     {lng: 2.33641832448427, lat: 48.85946575125334}, // south west
                //     {lng: 2.34268396474306, lat: 48.85675517962702}, // south east
                //     {lng: 2.34929292775576, lat: 48.85873165259772},  // north east
                //     {lng: 2.34534471608583, lat: 48.86403950804247}  // north east
                // ];
                ...
                //         // New point
                //         get_polygon_cordinates(bermudaTriangle);
                //     });
                //
        ...
        function validatezonedetails() {
            ...
            //CheckPreviousZone();
            $('#err_geofence_name, #err_zone_lat_long').html('');

            if ($('#geofence_name').val() == '') {
                formerror = 1;
                $('#err_geofence_name').append("Enter the zone name");
            }

            var existing_zone = $('#added_zone_details').val();
            var existing_zone_arr = existing_zone.split(",");

            var model_id = $('#model_id').val();
            var model_id_arr = model_id.split(",");

            if (formerror == 0) {
                var lat_longs = $('#geofence_latlng').val();

                $('#addcityzone_form').submit();
                return true;
            }
        }
        ...
        $(document).ready(function () {
            ...
            let service_type_id = {{$service_type}};
            if (service_type_id.length === $("input[class=checkbox]").length)
                $("#select_all").prop('checked',true);

            $.each(service_type_id,function (key,val) {
                $("input[class=checkbox][value="+val+"]").prop("checked",true);
            });
            ...
            }, "Enter valid zonename");


            /* $('#addcityzone_form').validate({ // initialize the plugin
                 rules: {
                     "geofence_name": {
                         required: true,
                         lettersonly: true
                 ...
                 messages: {
                     "geofence_name": {
                         required: 'Enter Zonename',
                         lettersonly: 'Enter valid zonename'
                     },
                     "zone_address": {
                         required: 'Enter Zone Address'
                     },
