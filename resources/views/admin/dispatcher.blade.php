...
@else
<script type="text/javascript" src="{{ asset('asset/js/dispatcher-map-admin-fr.js') }}"></script>
<script type="text/babel" src="{{ asset('asset/js/dispatcher-admin-fr.js') }}"></script>
@endif
