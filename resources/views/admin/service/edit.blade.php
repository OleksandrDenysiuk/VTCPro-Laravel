            ...
            <form class="form-horizontal" action="{{route('admin.service.update', $service->id )}}" method="POST" enctype="multipart/form-data" role="form">
               ...
               <!--  <div class="form-group row">
                ...
                <div class="form-group row" >
                    ...
                    <div class="col-xs-5">
                        <input class="form-control" type="text" value="{{ $service->hour }}" name="hour" id="hourly_price" placeholder="Set Hour Price (Only for DISTANCEHOUR)" min="0">
                    </div>
                    <div class="col-xs-5">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-5">
                        <input class="form-control" type="text" value="{{ $service->fixed }}" name="fixed" required id="fixed" placeholder="Base Price" min="0">
                    </div>
                    <div class="col-xs-5">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-5">
                        <input class="form-control" type="text" value="{{ $service->distance }}" name="distance" id="distance" placeholder="Base Distance" min="0">
                    </div>
                    <div class="col-xs-5">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-5">
                        <input class="form-control" type="text" value="{{ $service->minute }}" name="minute" id="minute" placeholder="Unit Time Pricing" min="0">
                    </div>
                    <div class="col-xs-5">
                        <span class="showcal"><i><b>@lang('admin.custom.price_pm') (@lang('admin.service.per_minute')), TM(@lang('admin.service.total_minute'))</b></i></span>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-5">
                        <input class="form-control" type="text" value="{{ $service->price }}" name="price" id="price" placeholder="Unit Distance Price" min="0">
                    </div>
                    <div class="col-xs-5">
                        <span class="showcal"><i><b>@lang('admin.custom.price_p'){{config('constants.distance')}} (@lang('admin.service.per') {{config('constants.distance')}}), T{{config('constants.distance')}} (@lang('admin.service.total') {{config('constants.distance')}})</b></i></span>
                    </div>
                </div>
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-xs-5">
                        <input class="form-control" type="text" value="{{ $service->capacity }}" name="capacity" required id="capacity" placeholder="Seat Capacity" min="1">
                    </div>
                </div>

                <div class="form-group row">
                    <label for="luggage_capacity" class="col-xs-2 col-form-label">@lang('admin.service.Luggage_Capacity')</label>
                    <div class="col-xs-5">
                        <input class="form-control numbers" type="text" pattern="\d*" value="{{ $service->luggage_capacity }}" name="luggage_capacity" required id="luggage_capacity" placeholder="@lang('admin.service.Luggage_Capacity')" min="1" maxlength="9">
                    </div>
                </div>
                ...
                <div class="form-group row">
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-xs-5">
                        <input class="form-control" type="text" value="{{ $service->waiting_free_mins }}" name="waiting_free_mins" id="waiting_free_mins" placeholder="@lang('admin.service.waiting_wave')" min="0">
                    </div>
                    <div class="col-xs-5">
                        <input class="form-control" type="text" value="{{ $service->waiting_min_charge }}" name="waiting_min_charge" id="waiting_min_charge" placeholder="@lang('admin.service.waiting_charge')" min="0">
                    </div>
                </div>
