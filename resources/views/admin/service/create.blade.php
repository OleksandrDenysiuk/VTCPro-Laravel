            ...
            <form class="form-horizontal" action="{{route('admin.service.store')}}" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group row">
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-xs-5">
                        <select class="form-control" id="calculator" name="calculator" style="padding:6px;">
                    ...
                    <div class="col-xs-5">
                        <span class="showcal"><i><b>@lang('admin.custom.price_calculation') <span id="changecal"></span></b></i></span>
                    </div>
                </div>
                ...
                <div class="form-group row" id="hour_price">
                    ...
                    <div class="col-xs-5">
                        <input class="form-control price" type="text" value="{{ old('fixed') }}" name="hour"  id="hourly_price" placeholder="@lang('admin.custom.set_hour')" min="0">
                    </div>
                    <div class="col-xs-5">
                        <span class="showcal"><i><b>@lang('admin.custom.price_ph') (@lang('admin.service.per_hour')), @lang('admin.custom.price_th') (@lang('admin.service.total_hour'))</b></i></span>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-5">
                        <input class="form-control price" type="text" value="{{ old('fixed') }}" name="fixed" required id="fixed" placeholder="@lang('admin.service.Base_Price')" min="0">
                    </div>
                    <div class="col-xs-5">
                        <span class="showcal"><i><b>@lang('admin.custom.price_bp') (@lang('admin.service.Base_Price'))</b></i></span>
                    </div>
                </div>
                <!-- Base distance -->
                <div class="form-group row">
                    ...
                    <div class="col-xs-5">
                        <input class="form-control price" type="text" value="{{ old('distance') }}" name="distance" required id="distance" placeholder="@lang('admin.service.Base_Distance')" min="0">
                    </div>
                    <div class="col-xs-5">
                        <span class="showcal"><i><b>@lang('admin.custom.price_bd') (@lang('admin.service.Base_Distance')) </b></i></span>
                    </div>
                </div>
                <!-- unit time pricing -->
                <div class="form-group row">
                    ...
                    <div class="col-xs-5">
                        <input class="form-control price" type="text" value="{{ old('minute') }}" name="minute" required id="minute" placeholder="@lang('admin.service.unit_time')" min="0">
                    </div>
                    <div class="col-xs-5">
                        <span class="showcal"><i><b>@lang('admin.custom.price_pm') (@lang('admin.service.per_minute')), @lang('admin.custom.price_tm')(@lang('admin.service.total_minute'))</b></i></span>
                    </div>
                </div>
                <!-- unit distance price -->
                <div class="form-group row">
                    ...
                    <div class="col-xs-5">
                        <input class="form-control price" type="text" value="{{ old('price') }}" name="price" required id="price" placeholder="@lang('admin.service.unit')" min="0">
                    </div>
                    <div class="col-xs-5">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-5">
                        <input class="form-control numbers" type="text" pattern="\d*" value="{{ old('capacity') }}" name="capacity" required id="capacity" placeholder="@lang('admin.service.Seat_Capacity')" min="1" maxlength="9">
                    </div>
                </div>

                <div class="form-group row">
                    <label for="luggage_capacity" class="col-xs-12 col-form-label">@lang('admin.service.Luggage_Capacity')</label>
                    <div class="col-xs-5">
                        <input class="form-control numbers" type="text" pattern="\d*" value="{{ old('luggage_capacity') }}" name="luggage_capacity" required id="luggage_capacity" placeholder="@lang('admin.service.Luggage_Capacity')" min="1" maxlength="9">
                    </div>
                </div>
                ...
                <div class="form-group row">
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-xs-5">
                        <input class="form-control numbers" type="text" value="{{ old('waiting_free_mins') }}" name="waiting_free_mins" id="waiting_free_mins" placeholder="@lang('admin.service.waiting_wave')" min="0">
                    </div>
                    <div class="col-xs-5">
                        <input class="form-control price" type="text" value="{{ old('waiting_min_charge') }}" name="waiting_min_charge" id="waiting_min_charge" placeholder="@lang('admin.service.waiting_charge')" min="0">
                    </div>
                </div>
