                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('admin.notification.destroy', $notify->id) }}" method="POST">
                                    ...
                                    <a href="{{ route('admin.notification.edit', $notify->id) }}" class="btn btn-info"><i class="fa fa-pencil"></i> @lang('admin.reason.ediis')</a>
                                    @endcan
                                    @can('notification-delete')
                                    <button class="btn btn-danger" onclick="return confirm('Are you sure?')"><i class="fa fa-trash"></i>  @lang('admin.reason.delle')</button>
                                    @endcan
                                    @endif
                                </form>
                            </td>
