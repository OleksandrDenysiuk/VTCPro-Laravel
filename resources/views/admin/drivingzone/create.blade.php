...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
            <a href="{{ route('admin.drivingzone.index') }}" class="btn btn-default pull-right"><i class="fa fa-angle-left"></i> @lang('admin.back')</a>
...
{{--            <p style="color: red;"> * Please choose only one option in country or location.</p>--}}
            <form class="form-horizontal" action="{{route('admin.drivingzone.store')}}" method="POST" enctype="multipart/form-data" role="form" style="margin-top: 20px;">
                ...
                <table class="table table-bordered">
                    <tbody>
                    <tr>
                        <td style="vertical-align: middle">@lang('admin.poi.status')</td>
                        <td>
                    ...
                    <tr>
                        <td style="vertical-align: middle"><div>@lang('admin.include.driving_restriction')</div><span>@lang('admin.include.add_countries')</span></td>
                        <td>
                            <select class="custom-select" multiple="multiple" id="start_country" name="start_country[]">
                                <option disabled="" selected>@lang('admin.include.list_driverzone')</option>
                    ...
                    <tr>
                        <td style="vertical-align: middle"><div>@lang('admin.include.driver_notset')</div><span>@lang('admin.include.driver_kilometers')</span></td>
                        <td>
                            <div style="margin-bottom: 10px;">
                                <input type="text" placeholder="@lang('admin.custom.book_enter_lo')" autocomplete="off" id="restict_start" name="restict_start" >
                ...
                <button type="submit" class="btn btn-primary">@lang('admin.include.driver_add')</button>
			</form>
		</div>
    </div>
</div>
