    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            ...
            <div class="box box-block bg-white">
                ...
                @endif
                <h5 class="mb-1">@lang('admin.include.driving_zone')</h5>
			   @can('dispute-create')
                <a href="{{ route('admin.drivingzone.create') }}" style="margin-left: 1em;" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> @lang('admin.include.driver_add')</a>
                @endcan
