				...
				<div class="form-group row">
					...
					<div class="col-xs-5">
						<div class="input-group">
							<input class="form-control" type="text" value="{{ old('name') }}" name="name" required id="namesearch" placeholder="@lang('admin.fleet.flesearchs')" required="" aria-describedby="basic-addon2" autocomplete="off">
				...
				<div class="form-group row">
					...
					<div class="col-xs-5">
		                <table class="table table-striped table-bordered dataTable requestList">
		                    ...
		                    <tbody>
		                   		<tr><td colspan="4">@lang('admin.custom.no_results')</td></tr>
		                    </tbody>
