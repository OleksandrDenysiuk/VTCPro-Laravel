            ...
            <table class="table table-striped table-bordered dataTable" id="table-6">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span style="color:white; padding:6px 10px; border-radius:3px; @if($pending->status == 'Pending') background-color:orange @elseif($pending->status == 'Accepted') background-color:green @elseif($pending->status == 'Refused') background-color:red @endif">@lang('admin.user_wallet_req_status.'.$pending->status)</span></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
