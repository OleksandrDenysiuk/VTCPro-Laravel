...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            <h5 class="mb-1">@lang('admin.custom.pending_request') @if($from_date) @lang('admin.payment.from') {{appDate($from_date)}} @endif @if($to_date) @lang('admin.payment.to') {{appDate($to_date)}} @endif</h5>
                ...
                <div class="modal-body">
                    <div id="sendbody" style="display:none">
                        <div class="alert alert-warning alert-dismissible">
                            <strong>@lang('admin.payment.wwhhs')</strong> <span id="setbody">@lang('admin.payment.tsradd')</span>
                        </div>
                    </div>
