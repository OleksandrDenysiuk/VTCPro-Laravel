...
<div class="content-area py-1">
    <div class="container-fluid">
        ...
        <div class="box box-block bg-white">
            <h5 class="mb-1">Total Transactions (@lang('provider.current_balance') : {{currency($wallet_balance)}}) @if($from_date) @lang('admin.payment.from') {{appDate($from_date)}} @endif @if($to_date) @lang('admin.payment.to') {{appDate($to_date)}} @endif</h5>
            ...
            <p style="color:red;">{{config('constants.booking_prefix', '') }} @lang('admin.payment.cliinfoss')</p>
        </div>
