...
{{--            @endif--}}
    ...
    <tr>
        <td colspan="2">
            <span style="font-size:14;">{{$admin->note}}</span>
        </td>
        <td align="right">
            <div style="width:80%;float: right;">
            <div><span style="font-size:14;">{{$admin->name}}</span></div>
            <div><span style="font-size:14;">{{$admin->address}}</span></div>
            <div><span style="font-size:14;">{{$admin->zip_code}}</span></div>
            <div><span style="font-size:14;">{{$admin->city}}</span></div>
            </div>
        </td>
    </tr>
</table>
