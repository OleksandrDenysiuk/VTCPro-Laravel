...
<script>
    ...
    function initMap() {
        ...
        div.innerHTML = '<img src="' + mapIcons['user'] + '"> ' + 'Utilisateurs';
        legend.appendChild(div);

        var div = document.createElement('div');
        div.innerHTML = '<img src="' + mapIcons['offline'] + '"> ' + 'Chauffeurs non dipo.';
        legend.appendChild(div);

        var div = document.createElement('div');
        div.innerHTML = '<img src="' + mapIcons['active'] + '"> ' + 'Chauffeurs dispo.';
        legend.appendChild(div);

        var div = document.createElement('div');
        div.innerHTML = '<img src="' + mapIcons['unactivated'] + '"> ' + 'Chauffeurs non active';
        legend.appendChild(div);
