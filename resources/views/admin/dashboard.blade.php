                    ...
                    <div class="container">
                        <div class="row chart-footer">
                            <div class="col-md-6 foot-c-box"><span
                                        class="fc-scolor"></span>{{$rides->count() - $user_cancelled - $provider_cancelled}}
                                <span class="fctxt">@lang('admin.dashboard.completed_ride')</span></div>
                            <div class="col-md-6 foot-c-box"><span
                                        class="fc-fcolor"></span>{{$user_cancelled + $provider_cancelled}}<span
            ...
            <div class="col-lg-4 col-md-12 col-sm-12">
                ...
                <div class="admin-dash-rt white-admin-box admin-mid-box">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-8 col-8 dash-lftb">
                                <span>@lang('admin.dashboard.Paymentrequest')</span><a
                                        href="{{ route('admin.payment_request') }}">@lang('admin.dashboard.Viewall')</a>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-8 col-8 dash-lftb">
                                <span>@lang('admin.dashboard.UnpaidInvoices')</span><a
                                        href="#">@lang('admin.dashboard.Viewall')</a></div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-4 dash-rttb">0</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row cont-bot-main">
            <div class="col-md-4 col-sm-4">
                <div class="monthly-rev">
                    ...
                    <div class="month-rps">{{currency($commission->commission)}}</div>
                        ...
                        <div class="table-responsive">
                            @can('wallet-summary')
                                <table class="table table-new projectspage indexpage" data-pagination="true"
                                    ...
                                    <tr>
                                        <th scope="row">@lang('admin.dashboard.Companiesdebit')</th>
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            var data = google.visualization.arrayToDataTable([
                ...
                ["@lang('admin.dashboard.completed_ride')", {{$rides->count() - $user_cancelled - $provider_cancelled}}]
            ]);
            var options = {
                title: '',
                pieHole: 0.8,
